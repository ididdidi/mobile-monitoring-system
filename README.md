...
![Pic.1. Structural diagram](https://mofrison.ru/mobile-monitoring-system/assets/images/structural-diagram.png "Pic.1. Structural diagram")
...
![Pic.2. Block diagram](https://mofrison.ru/mobile-monitoring-system/assets/images/block-diagram.gif "Pic.2. Block diagram")
...
![Pic.3. Class diagram](https://mofrison.ru/mobile-monitoring-system/assets/images/class-diagram.jpg "Pic.3. Class diagram")
...
![Pic.4. Application database](https://mofrison.ru/mobile-monitoring-system/assets/images/application-database.png "Pic.4. Application database")
...
![Pic.5. Navigation map](https://mofrison.ru/mobile-monitoring-system/assets/images/navigation-map.png "Pic.5. Navigation map")
